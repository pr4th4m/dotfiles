# Generated by Powerlevel10k configuration wizard on 2019-08-02 at 11:08 AEST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 28680.
# Wizard options: powerline, lean, 2 lines, disconnected, sparse, concise.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND=010
  ...
  vcs+='${${VCS_STATUS_LOCAL_BRANCH:+%242F${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${VCS_STATUS_LOCAL_BRANCH//\%/%%}}'
  ...
  vcs+='${${VCS_STATUS_NUM_STAGED:#0}:+ %011F+${VCS_STATUS_NUM_STAGED}}'
  # !42 if have unstaged changes.
  vcs+='${${VCS_STATUS_NUM_UNSTAGED:#0}:+ %011F!${VCS_STATUS_NUM_UNSTAGED}}'
